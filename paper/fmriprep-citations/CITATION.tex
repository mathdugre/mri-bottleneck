...
using \emph{fMRIPrep} 23.0.2 (\citet{fmriprep1}; \citet{fmriprep2};
...
distributed with ANTs 2.4.2 \citep[RRID:SCR\_004757]{ants}, and used as
...
brain-extracted T1w using \texttt{fast} \citep[FSL 6.0.6.4,
RRID:SCR\_002823,][]{fsl_fast}. Brain surfaces were reconstructed using
\texttt{recon-all} \citep[FreeSurfer 7.3.3-20231213-debug,
...
2.4.2), using brain-extracted versions of both T1w reference and the T1w
...
6.0.6.4,][]{mcflirt}. BOLD runs were slice-time corrected to 0.961s (0.5
of slice acquisition range 0s-1.92s) using \texttt{3dTshift} from AFNI
20230309 \citep[RRID:SCR\_005927]{afni}. The BOLD time-series (including
